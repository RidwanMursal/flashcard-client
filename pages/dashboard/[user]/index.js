...
import { getUser, getAllUsers } from '../../../api/getRequests'
  ...
  if (width && width > 900) {
    ...
    return (
      <div className={styles.container}>
        ...
        <Sidebar width={"100%"} username={userData?.username} profilePicture={userData.profile_picture} /> 
